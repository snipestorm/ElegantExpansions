...
public class ModArmorItem extends ArmorItem {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.INFUSED_DIAMOND, new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE,200,0))
                    .put(ModArmorMaterials.INFUSED_RUBY, new MobEffectInstance(MobEffects.DIG_SPEED,200,0))
                    .put(ModArmorMaterials.INFUSED_SAPPHIRE, new MobEffectInstance(MobEffects.WATER_BREATHING,200,0))
                    .put(ModArmorMaterials.INFUSED_EMERALD, new MobEffectInstance(MobEffects.MOVEMENT_SPEED,200,0))
                    .put(ModArmorMaterials.INFUSED_AMETHYST, new MobEffectInstance(MobEffects.NIGHT_VISION,200,0))
                    .put(ModArmorMaterials.INFUSED_CITRINE, new MobEffectInstance(MobEffects.FIRE_RESISTANCE,200,0))
                    .put(ModArmorMaterials.INFUSED_TANZANITE, new MobEffectInstance(MobEffects.SLOW_FALLING,200,0))
                    .put(ModArmorMaterials.INFUSED_ONYX, new MobEffectInstance(MobEffects.DAMAGE_BOOST,200,0))
                    .build();
