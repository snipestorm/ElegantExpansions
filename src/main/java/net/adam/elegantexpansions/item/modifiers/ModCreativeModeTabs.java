...
public class ModCreativeModeTabs {
    ...
    public static RegistryObject<CreativeModeTab> ELEGANT_EXPANSIONS_FOOD = CREATIVE_MODE_TABS.register("elegant_expansions_food", () ->
            CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.EXOTIC_MEAT.get()))
                    .title(Component.translatable("creativemodetab.elegant_expansions_food")).build());
