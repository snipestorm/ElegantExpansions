...
public class LargeBananaFoliagePlacer extends FoliagePlacer {
    public static final Codec<LargeBananaFoliagePlacer> CODEC = RecordCodecBuilder.create((instance) -> foliagePlacerParts(instance)
            .and(Codec.intRange(0,16).fieldOf("height").forGetter(fp -> fp.height)).apply(instance, LargeBananaFoliagePlacer::new));

    protected final int height;

    public LargeBananaFoliagePlacer(IntProvider p_161411_, IntProvider p_161412_, int height) {
    ...
    protected FoliagePlacerType<?> type() {
        return ModFoliagePlacerTypes.LARGE_BANANA_FOLIAGE_PLACER.get();
    }
    ...
    protected void createFoliage(LevelSimulatedReader pLevel, FoliageSetter foliageSetter, RandomSource pRandom, TreeConfiguration pConfig, int maxFreeTreeHeight,
        ...
        for(int i = 0; i < 2; i++) {
            ...
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(3).relative(Direction.EAST,2));
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(4).relative(Direction.EAST,2));
            ...
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(5).relative(Direction.EAST,3));
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(6).relative(Direction.EAST,3));
            ...
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(3).relative(Direction.WEST,2));
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(4).relative(Direction.WEST,2));
            ...
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(5).relative(Direction.WEST,3));
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(6).relative(Direction.WEST,3));
            ...
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(3).relative(Direction.NORTH,2));
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(4).relative(Direction.NORTH,2));
            ...
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(5).relative(Direction.NORTH,3));
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(6).relative(Direction.NORTH,3));
            ...
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(3).relative(Direction.SOUTH,2));
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(4).relative(Direction.SOUTH,2));
            ...
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(5).relative(Direction.SOUTH,3));
            tryPlaceLeaf(pLevel, foliageSetter, pRandom, pConfig,  attachment.pos().below(6).relative(Direction.SOUTH,3));
